...
Then, we render the content and call GenData, the component that stores raw data. This component will hold all the logic for the randomizing function because it splits the item-content string and converts it into an array, which is needed for the randomizer functionality.
